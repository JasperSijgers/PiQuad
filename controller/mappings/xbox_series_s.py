...
class XboxSeriesSMapping:
    ...
    def add_joy_mapping(self, joy, index, inverse=False, offset=0):
        self.joy_mappings[joy.value] = JoyMapping(index, inverse, offset)
    ...
    def setup_mappings(self):
        ...
        self.add_joy_mapping(Joy.LEFT_STICK_HORIZONTAL, 2, False, -128)
        self.add_joy_mapping(Joy.LEFT_STICK_VERTICAL, 4, True, 128)
        self.add_joy_mapping(Joy.RIGHT_STICK_HORIZONTAL, 6, False, -128)
        self.add_joy_mapping(Joy.RIGHT_STICK_VERTICAL, 8, True, 128)
